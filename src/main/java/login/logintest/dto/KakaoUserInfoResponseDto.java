...
/**
 * 사용자가 동의한 항목만 담겨지고, 동의하지 않은 항목은 null로 들어오게 된다.
 * 처음에 두가지 동의를 하게 설정했기때문에 나머지는 다 null로 들어오게됨
 */
@Getter
...
public class KakaoUserInfoResponseDto {
    ...
    @Getter
    @NoArgsConstructor
    @JsonIgnoreProperties(ignoreUnknown = true)//JSON에 DTO에 정의되지 않은 추가 필드가 있어도 무시하라는 설정입니다.
